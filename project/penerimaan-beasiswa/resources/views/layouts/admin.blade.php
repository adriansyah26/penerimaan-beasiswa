    ...
    <div class="wrapper" style="display: block">
        ...
        <nav class="main-header navbar navbar-expand {{ auth()->user()->theme()['navbar'] ?? 'navbar-light' }}">
            ...
            <ul>
                <li class="nav-link" style="padding-left: 0">{{ strtoupper(App::getLocale('locale')) }}
                    ...
                    <ul>
                        <li><a href="/language/en"><i class="sl-flag flag-en"><div id="english"></div></i> <span>En</span></a></li>
        ...
        <aside class="main-sidebar elevation-1 {{ auth()->user()->theme()['sidebar'] ?? 'sidebar-dark-primary' }}">
            ...
            <a href="#" class="brand-link">
                <img src="{{ asset('images/widuri.png') }}" alt="Unired Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <div class="brand-text">
                    <span class="align-text-top font-weight-light">Beasiswa</span>
                    <span class="font-weight-bold"><small>STMIK WIDURI</small></span>
                </div>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://wa.me/6289669564666" target="_blank">Adriansyah
                </a>.</strong>
            All rights reserved.
