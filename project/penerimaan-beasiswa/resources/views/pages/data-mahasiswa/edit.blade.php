            ...
            <div class="col-lg-8 offset-lg-2 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">@lang('global.edit') Data Mahasiswa</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Pilih Program Studi" name="prodi" id="prodi"
                                        ...
                                        <option></option>
                                        <option value="1" {{ $mahasiswa->prodi == 1 ? 'selected' : ''}}>Teknik Informatika</option>
                                        <option value="2" {{ $mahasiswa->prodi == 2 ? 'selected' : ''}}>Sistem Informasi</option>
                                    </select>
                                    @if($errors->has('prodi'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pendapatan" name="pendapatan"
                                        ...
                                        value="{{ old('pendapatan', isset($mahasiswa) ? $mahasiswa->penghasilan_orang_tua : '') }}">
