...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Normalisasi Matriks Keputusan Management</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">@lang('global.home')</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('kriteria.index') }}">Normalisasi Matriks Keputusan Management</a></li>
        ...
        <div class="col-lg-8 offset-lg-2 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Membuat Normalisasi Matriks Keputusan</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

                    <form action="{{ route('normalisasi-matriks-keputusan.store') }}" method="POST">
                        @csrf
