...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Normalisasi Matriks Terbobot</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">@lang('global.home')</a></li>
                    <li class="breadcrumb-item active">Normalisasi Matriks Terbobot</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Normalisasi Matriks Terbobot</h3>
                ...
                <div class="card-body">
                    ...
                    <table id="dataTable"
                        ...
                        <tbody>
                            @php $no = 1; @endphp
                            @foreach($matriks_terbobot as $normalisasi)
                            <tr class="text-center">
                                <td>{{$no++}}</td>
                                <td>
                                    @foreach ($normalisasi->mahasiswa as $item)
                                        {{ $item->nama }}
                                    @endforeach
                                </td>
                                <td>
