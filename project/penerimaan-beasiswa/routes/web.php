...
use App\Http\Controllers\Blade\DataMahasiswaController;
use App\Http\Controllers\Blade\LaporanController;
...
Route::group(['middleware' => 'auth'],function (){
    ...
    Route::prefix('admin')->namespace('Blade')->group(function () {
        Route::resource('data-mahasiswa', 'DataMahasiswaController');
        Route::get('mahasiswa-print', [DataMahasiswaController::class, 'print'])->name('data-mahasiswa.print');
        Route::resource('kriteria', 'KriteriaController');
        Route::resource('sub-kriteria', 'SubKriteriaController');
        Route::resource('perbandingan-berpasangan', 'PerbandinganBerpasanganController');
        Route::resource('matriks-normalisasi', 'MatriksNormalisasiController');
        Route::resource('nilai-bobot-kriteria', 'NilaiBobotKriteriaController');
        Route::resource('matriks-keputusan', 'MatriksKeputusanController');
        Route::resource('normalisasi-matriks-keputusan', 'NormalisasiMatriksKeputusanController');
        Route::resource('normalisasi-matriks-terbobot', 'NormalisasiMatriksTerbobotController');
        Route::resource('solusi-ideal-positif-negatif', 'SolusiIdealPositifNegatifController');
        Route::resource('jarak-positif-negatif', 'JarakPositifNegatifController');
